...
**Status Update --jason: SAM2 is the current model, in order to test, run scripts/videopredictior.py after downloading checkpoints and setting the proper directories. For videos use a collection of frames as images in a folder (i used ffmpeg to deconstruct) 
